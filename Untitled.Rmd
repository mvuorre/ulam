...
# Goal
\textbf{What is the goal of statistical analysis in science?}
...
Stan uses Hamiltonian MCMC to approximate $p(\theta \mid y)$. See https://observablehq.com/@herbps10/hamiltonian-monte-carlo for an animated explaination.
